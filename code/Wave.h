...
void wave() {
  ...
  static const uint8_t scaleWidth = 256 / kMatrixWidth;
  static const uint8_t scaleHeight = 256 / kMatrixHeight;

  static const uint8_t maxX = kMatrixWidth - 1;
  static const uint8_t maxY = kMatrixHeight - 1;
